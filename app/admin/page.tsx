...
export default async function AdminPage() {
  ...
  return <AdminDesktopPanel signedInAs={profile.username||'admin'} users={users} requests={requests} ledger={ledger} totalCommission={totalCommission} adminWallet={adminWallet} chargeRules={chargesR.data||[]} commissionRules={commissionRulesR.data||[]} commissions={commissions} permissions={permissionsR.data||[]} userPermissions={userPermsR.data||[]} audit={audit} topupLocations={topupLocationsR.data||[]}/>;
}